...
- Demonstrate how real-world datasets can connect classroom coding exercises to fisheries management topics.
- Provide a short example lesson and resources instructors can adapt.

Target audience & prerequisites:
- Introductory-to-intermediate R users (basic familiarity with R and RStudio / ggplot and tidyverse).
